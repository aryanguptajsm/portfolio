  ...
  return (
    <section id="projects">
      ...
      <div className="projects-grid">
        ...
        <a className="project-card reveal" href="https://github.com/aryanguptajsm/Argus" target="_blank" rel="noreferrer">
        ...
        <a className="project-card reveal" href="https://github.com/aryanguptajsm/storix" target="_blank" rel="noreferrer">
          <div className="project-top">
        ...
        <a className="project-card reveal" href="https://github.com/aryanguptajsm/slingshot" target="_blank" rel="noreferrer">
          <div className="project-top">
        ...
        <a className="project-card reveal" href="https://github.com/aryanguptajsm/securegen" target="_blank" rel="noreferrer">
          <div className="project-top">
        ...
        <a className="project-card reveal" href="https://github.com/aryanguptajsm/weatherapp" target="_blank" rel="noreferrer">
          <div className="project-top">
        ...
        <a className="project-card reveal" href="https://github.com/aryanguptajsm/promptiva" target="_blank" rel="noreferrer">
          <div className="project-top">
            <div className="project-icon" style={{background: 'rgba(124,90,243,0.15)'}}></div>
          </div>
